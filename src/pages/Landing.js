    ...
    <div className=" landing-page">
      ...
      <div className="hero">
        <div className="first-half ">
          <div className=" bg-contain bg-clg-logo clg-logo bg-no-repeat clg-logo"></div>
          <h2 className="text-[75px] font-bold ">
            Welcome to Campus <br /> Placement Portal
            <br /> SPEC
          </h2>
          <p className="text-[24px]  mb-20">
            Transforming Placement Engagement in Universities
          </p>
          <div className="btn-grp">
            <a href="/register" className="btn">
              Get Started
            </a>
            <a href="/login" className="btn log-in-btn">
              Login
            </a>
          </div>
        </div>
        <div className="second-half">
          <div className="bg-hero-image w-full h-full bg-cover bg-center hero-img"></div>
        </div>
      </div>
    </div>
  );
            ...
            <div className="mt-10">
              <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
                <FeatureBox
                  ...
                  description={
                    "Our platform makes it easy for CTAE Placement Head and Student in placement process"
                  }
                  icon={<FaCheckCircle />}
                />
                <FeatureBox
