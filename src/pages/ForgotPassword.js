...
const ForgotPassword = () => {
  ...
  return (
    <div className="m-auto  bg-clg-image bg-cover ">
      <Logo />
      ...
      >
        <div className="lg:p-[36px]  p-4 lg:mt-8 mt-14   w-full  md:w-[100%] lg:w-[50%] md:mx-0 mx-auto border border-black rounded-lg shadow-xl  bg-white">
